      ...
      <div className='mb-3 flex h-6 w-full items-center rounded-lg border-2 border-[#1fd0ec] p-5 hover:bg-[#1fd0ec]'>
        <div className='mr-4 flex items-center'>
          <input
            ...
            type='checkbox'
            defaultValue
            className='h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-[#1fd0ec] dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600'
          />
        </div>
        <div></div>
      </div>
