    ...
    <HomeLayout>
      <header className='h-[900px] bg-gradient-to-b from-cyan-300 px-4 pt-16 sm:h-[800px]'>
        <div className='container  flex flex-col-reverse lg:flex-row lg:items-center lg:justify-between'>
          <div className='smd:max-w-md w-full px-6 lg:w-1/2'>
          ...
          <div className='container flex items-center'>
            <div className='w-screen'>
              ...
              <div className='mt-10 flex'>
                ...
                <div className='mt-3 ml-5 lg:max-w-lg'>
                  <h2 className='font-semibold md:text-lg'>
                    Membantu sistem ingatan dalam proses belajar dengan merangsang memori dengan konsep reward dan
                    kemajuan{' '}
                  </h2>
                </div>
              </div>
              ...
              <div className='mt-10 flex'>
                ...
                <div className='mt-3 ml-5 lg:max-w-lg'>
                  <h2 className='font-semibold md:text-lg'>
                    Menjadikan data statistik yang ada selama proses belajar menjadi bahan acuan untuk mengetahui
                    sebagus apa pembeljaran yang telah dilakukan{' '}
                  </h2>
                </div>
              </div>
            </div>
