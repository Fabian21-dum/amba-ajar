...
export default function DashTodo(){
    return(
        ...
        <div className="relative bg-white border-solid h-fit w-max border-[rgba(232,231,231,1)] rounded-[10px]">
          <div className="flex-container-1">
            <div className='pr-10'>
            <span className="flex font-bold text-4xl m-10 pr-10">TO DO LIST</span>
