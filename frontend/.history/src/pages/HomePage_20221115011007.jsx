    ...
    <HomeLayout>
      ...
      <section className='bg-gradient-to-b from-cyan-300 py-8'>
        <div className='container'>
          ...
          <div className='w-full lg:w-1/2'>
            <img className='mx-auto w-96 lg:w-auto' src={HomeBook} alt='vector-1' />
          </div>
          <div className='py-5 lg:w-1/2 lg:max-w-lg'>
            <h2 className='pb-5 text-4xl font-semibold md:text-5xl lg:text-6xl'>Liat Keseharian Anda Dalam Belajar.</h2>
          </div>
