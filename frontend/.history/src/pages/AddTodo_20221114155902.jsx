      ...
      <div className="flex w-full flex-col gap-4 p-4">
        ...
        <div className="relative bg-white border-solid border w-[1099px] h-96 top-[0px] border-[rgba(232,231,231,1)] rounded-[10px]">
          ...
          <div className='flex rounded-[10px]'>
            ...
            <button className="relative mb-5 w-[143.48px] h-[45px] left-[1000px]  bg-gradient-to-r from-[rgba(25,201,229,1)] to-[rgba(7,154,187,1)] rounded-[10px] text-white text-center hover:bg-gradient-to-br">Tambah Data</button>
