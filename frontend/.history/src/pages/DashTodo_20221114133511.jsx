...
export default function DashTodo(){
    return(
        ...
        <div className="flex bg-white border-solid h-fit w-max border-[rgba(232,231,231,1)] rounded-[10px]">
          <div className="flex">
            <span className="flex font-bold w-5 text-4xl mr-10 pr-10">TO DO LIST</span>
