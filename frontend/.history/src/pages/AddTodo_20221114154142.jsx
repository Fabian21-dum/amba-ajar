    ...
    return(
      ...
      <div className="flex w-full flex-col gap-4 p-4">
        ...
        <div className="relative bg-white border-solid border w-[1167px] h-96 top-[0px] border-[rgba(232,231,231,1)] rounded-[10px]">
          ...
          <div className='ounded-[10px] flex'>
            <div className='mt-10'>
            ...
            <span className='text-xl font-bold mt-10 ml-12'>Tanggal</span>
            <input type="date" name='tanggal' id='tanggal' className='ml-12 mt-5 rounded-[15px] border-solid border-2 border-black w-full h-[40px]' />
            </div>
