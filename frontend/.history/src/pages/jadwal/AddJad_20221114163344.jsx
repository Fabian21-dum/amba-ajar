    ...
    return(
      ...
      <div className="flex w-full h-screen flex-col gap-4 p-4">
        ...
        <div className="relative bg-white border-solid border w-[1099px] h-fit top-[0px] border-[rgba(232,231,231,1)] rounded-[10px]">
            <span className="relative left-[45px] top-[20px] font-bold text-4xl">TAMBAH Jadwal</span>
          ...
          <div className='ml-12 mr-3'>
              <span className='text-xl font-bold mt-10'>bla1</span>
              <input type="text" name='todo' id='todo' className='mb-5 mt-5 rounded-[15px] border-solid border-2 border-black w-full h-[50px]' />
            </div>
            <div className='ml-12 mr-3'>
              <span className='text-xl font-bold mt-10'>bla2</span>
              <input type="text" name='todo' id='todo' className='mb-5 mt-5 rounded-[15px] border-solid border-2 border-black w-full h-[50px]' />
            </div>
            <div className='ml-12 mr-3'>
              <span className='text-xl font-bold mt-10'>bla3</span>
              <input type="text" name='todo' id='todo' className='mb-5 mt-5 rounded-[15px] border-solid border-2 border-black w-full h-[50px]' />
            </div>
