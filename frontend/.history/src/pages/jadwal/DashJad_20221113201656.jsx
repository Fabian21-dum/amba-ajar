        ...
        <table className="bg-white mt-10 mb-5 w-full border rounded-[30px]">
            ...
            <tbody>
                ...
                <tr className="bg-white-100 text-center border-b text-sm text-white-600">
                    ...
                    <td>
                        <button href="#" className=" mr-2 w-[69px] h-[29px] bg-gradient-to-br from-[rgba(51,121,246,1)] to-[rgba(26,90,227,1)] rounded-[10px] hover:bg-gradient-to-br text-white">Edit</button>
