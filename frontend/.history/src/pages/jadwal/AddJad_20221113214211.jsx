...
export default function AddJad(){
    return(
      ...
      <div className="flex h-screen w-full flex-col gap-4 p-4">
         <div className='flex h-2/3 w-8/12 flex-row justify-center gap-4'>
        <div className="relative bg-white border-solid border w-min h-fit top-[0px] drop-shadow-lg border-[rgba(232,231,231,1)] rounded-[10px]">
