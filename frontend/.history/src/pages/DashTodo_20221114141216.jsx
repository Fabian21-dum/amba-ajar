...
export default function DashTodo(){
    return(
        ...
        <div className='flex h-2/3 w-max flex-row justify-center gap-4'>
        <div className="flex bg-white border-solid border w-[1167px] h-fit top-[0px] border-[rgba(232,231,231,1)] rounded-[10px]">
          <div className="flex-container-1 mt-5 ml-10">
            <span className="w-96 font-bold text-4xl">TO DO LIST</span>
            <div>
            <Link to='/dashboard/AddTodo'>
            <button className="w-[143.48px] h-[45px] bg-gradient-to-r from-[rgba(25,201,229,1)] to-[rgba(7,154,187,1)] rounded-[10px] text-white text-center hover:bg-gradient-to-br">Tambah Data</button>
            </Link>
            </div>
          <div className="flex p-2 rounded-[10px] w-[1100px]">
        <table className="w-full bg-white mt-10 mb-5 border rounded-[30px]">
            <thead>
