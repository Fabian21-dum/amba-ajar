...
import HomeBook  from '../assets/icons/Group 3.png';
import Brain  from '../assets/icons/Group 4.png';
import Chart  from '../assets/icons/Group 5.png';
    ...
    <HomeLayout>
      ...
      <section className='bg-gradient-to-b from-cyan-300 py-8'>
        <div className='container'>
          ...
          <div className='container flex flex-col items-center justify-start  lg:flex-row'>
          <div className='scale-[0.3]'>
            <img className='lg:w-auto'  src={HomeBook} alt='home' />
          </div>
          <div className='lg:max-w-lg'>
            <h2 className='font-semibold w-[1000px] md:text-lg'>
            Progres yang tersusun dengan segala fitur yang ada untuk memudahkan dalam peroses selama belajar
            </h2>
          </div>

          <div className='flex'>
            <img className='lg:w-auto'  src={Brain} alt='home' />
          </div>
          <div className='w-au lg:max-w-lg'>
            <h2 className='font-semibold md:text-lg'>
            Membantu sistem ingatan dalam proses belajar dengan merangsang memori dengan konsep reward dan kemajuan            </h2>
          </div>
          <div className='flex'>
            <img className='flex lg:w-auto'  src={Chart} alt='home' />
          </div>
          <div className='flex w-au lg:max-w-lg'>
            <h2 className='flex font-semibold md:text-lg'>
