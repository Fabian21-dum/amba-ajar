          ...
          <div className='h-full w-[956px] rounded-[20px] bg-white p-4 shadow-xl'>
            <div className='flex justify-between px-4'>
              ...
              <div>
                <button
                  type='button'
                  className='mr-2 mb-2 rounded-lg bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 px-5 py-2.5 text-center text-sm font-medium text-white shadow-md  hover:bg-gradient-to-br focus:outline-none focus:ring-4 focus:ring-cyan-300 dark:shadow-lg dark:shadow-cyan-800/80 dark:focus:ring-cyan-800'
                >
                  Selengkapnya
                </button>
              </div>
