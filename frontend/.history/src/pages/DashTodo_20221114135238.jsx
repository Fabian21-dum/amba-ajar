    ...
    return(
        ...
        <div className="flex bg-white border-solid border w-[1167px] h-fit top-[0px] border-[rgba(232,231,231,1)] rounded-[10px]">
          <div className="flex-container-1 mt-5">
            ...
            <button className="left-[500px] flex w-[143.48px] h-[45px] bg-gradient-to-r from-[rgba(25,201,229,1)] to-[rgba(7,154,187,1)] rounded-[10px] text-white text-center hover:bg-gradient-to-br">Tambah Data</button>
            </Link>
